...
#        self.jobscript.append("#SBATCH -p lindahl\n")
        self.jobscript.append("#SBATCH -p cryoem\n")
        ...
        self.jobscript.append("#SBATCH --ntasks-per-node=28\n")
        ...
        self.jobscript.append(
            ...
            ":" +
            self.port +
            " --memory-limit=auto --nthreads 2 --nworkers 1 --death-timeout 60\n")
